...
describe("connectionService", () => {
  ...
  describe("sendConnectionRequest", () => {
    ...
    it("handles 409 conflict when connection already exists", async () => {
      ...
      await expect(connectionService.sendConnectionRequest(mockTargetUserId)).rejects.toEqual(
        mockError
      );
    });
    ...
    it("handles server errors correctly", async () => {
      ...
      await expect(connectionService.sendConnectionRequest(mockTargetUserId)).rejects.toThrow(
        "Server error"
      );
    });
  });
  ...
  describe("acceptConnectionRequest", () => {
    ...
    it("handles 404 when connection not found", async () => {
      ...
      await expect(connectionService.acceptConnectionRequest("invalid-id")).rejects.toEqual(
        mockError
      );
    });
  });
  ...
  describe("declineConnectionRequest", () => {
    ...
    it("handles server errors correctly", async () => {
      ...
      await expect(connectionService.declineConnectionRequest("conn-1")).rejects.toThrow(
        "Server error"
      );
    });
  });
  ...
  describe("removeConnection", () => {
    ...
    it("handles 404 when connection not found", async () => {
      ...
      await expect(connectionService.removeConnection("invalid-id")).rejects.toEqual(mockError);
    });
  });
  ...
  describe("getPendingRequests", () => {
    ...
    it("handles server errors correctly", async () => {
      ...
      await expect(connectionService.getPendingRequests()).rejects.toThrow("Server error");
    });
  });
  ...
  describe("getConnectionStatus", () => {
    it('returns "none" when no connection exists', async () => {
      ...
      expect(axiosPrivate.get).toHaveBeenCalledWith(`/connections/status/${mockTargetUserId}`);
    ...
    it("handles server errors correctly", async () => {
      ...
      await expect(connectionService.getConnectionStatus(mockTargetUserId)).rejects.toThrow(
        "Server error"
      );
    });
  });
