...
describe("ThemedText", () => {
  ...
  describe("Text Presentation Types", () => {
    it('should display title-sized text when type is "title"', () => {
      render(
        <ThemedText type="title" testID="title-text">
          Title
        </ThemedText>
      );
    ...
    it('should display subtitle-sized text when type is "subtitle"', () => {
      render(
        <ThemedText type="subtitle" testID="subtitle-text">
          Subtitle
        </ThemedText>
      );
    ...
    it('should display semibold text when type is "defaultSemiBold"', () => {
      render(
        <ThemedText type="defaultSemiBold" testID="semibold-text">
          SemiBold
        </ThemedText>
      );
    ...
    it('should display link-styled text when type is "link"', () => {
      render(
        <ThemedText type="link" testID="link-text">
          Link
        </ThemedText>
      );
  ...
  describe("Accessibility", () => {
    it("should be accessible with accessibility label", () => {
      render(<ThemedText accessibilityLabel="Accessible Text">Content</ThemedText>);
