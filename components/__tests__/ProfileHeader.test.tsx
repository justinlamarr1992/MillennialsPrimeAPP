...
describe("ProfileHeader - User Behavior", () => {
  ...
  describe("Given a user views their own profile", () => {
    it("should display their full name", () => {
      render(<ProfileHeader user={mockUser} isOwnProfile={true} onEditPress={mockOnEditPress} />);
  ...
  describe("Given a user views another user profile", () => {
    it("should display the other user name", () => {
      render(
        <ProfileHeader user={mockUser} isOwnProfile={false} onConnectPress={mockOnConnectPress} />
      );
  ...
  describe("Given different user data formats", () => {
    ...
    it("should show firstName and lastName when name field is empty", () => {
      ...
      render(
        <ProfileHeader user={userWithSplitName} isOwnProfile={true} onEditPress={mockOnEditPress} />
      );
    ...
    it('should show "User" when no name information is available', () => {
      ...
      render(
        <ProfileHeader user={userWithNoName} isOwnProfile={true} onEditPress={mockOnEditPress} />
      );
  ...
  describe("Given special characters and unicode", () => {
    ...
    it("should display locations with unicode characters correctly", () => {
      ...
      render(
        <ProfileHeader user={userWithUnicode} isOwnProfile={true} onEditPress={mockOnEditPress} />
      );
  ...
  describe("Component stability", () => {
    it("should render without crashing", () => {
      expect(() => render(<ProfileHeader user={mockUser} isOwnProfile={true} />)).not.toThrow();
    });
