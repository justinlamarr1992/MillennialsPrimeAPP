...
describe("ProfilePicture", () => {
  ...
  describe("User sees appropriate UI based on state", () => {
    it('shows "Tap to add photo" when no image and editable', () => {
      render(<ProfilePicture imageUri={null} onImageSelected={mockOnImageSelected} />);
    ...
    it("hides placeholder text when image is provided", () => {
      ...
      render(<ProfilePicture imageUri={testUri} onImageSelected={mockOnImageSelected} />);
    ...
    it("shows placeholder when imageUri is a raw ID instead of a valid URI", () => {
      render(
        <ProfilePicture imageUri="6988bc396a977b0030ea7b9e" onImageSelected={mockOnImageSelected} />
      );
    ...
    it("shows edit button when editable", () => {
      render(
        <ProfilePicture imageUri={null} onImageSelected={mockOnImageSelected} editable={true} />
      );
    ...
    it("hides edit button when not editable", () => {
      render(
        <ProfilePicture imageUri={null} onImageSelected={mockOnImageSelected} editable={false} />
      );
