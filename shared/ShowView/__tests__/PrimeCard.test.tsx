...
describe("PrimeCard", () => {
  ...
  describe("Content Edge Cases", () => {
    ...
    it("should handle unicode characters", () => {
      render(<PrimeCard {...defaultProps} title="ビデオ Video" description="説明 Description" />);
    ...
    it("should handle emojis in content", () => {
      render(<PrimeCard {...defaultProps} title="Great Video 🎬" description="Must watch! 🔥" />);
  ...
  describe("Date Formatting", () => {
    ...
    it("should display custom date formats", () => {
      ...
      dates.forEach((date) => {
        ...
        expect(
          screen.getByText(
            new RegExp(`Date Uploaded:.*${date.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")}`)
          )
        ).toBeTruthy();
        unmount();
      });
