  ...
  describe("validateEmail", () => {
    ...
    describe("invalid emails", () => {
      ...
      it("should return error for missing domain", () => {
        expect(validateEmail("test@")).toBe("Invalid email format (e.g., user@example.com)");
      });

      it("should return error for missing username", () => {
        expect(validateEmail("@example.com")).toBe("Invalid email format (e.g., user@example.com)");
      });

      it("should return error for missing TLD", () => {
        expect(validateEmail("test@example")).toBe("Invalid email format (e.g., user@example.com)");
      });
  ...
  describe("validatePassword", () => {
    ...
    describe("invalid passwords - missing lowercase", () => {
      ...
      it("should return error for all uppercase and numbers", () => {
        expect(validatePassword("PASS1234!")).toBe("Password must contain a lowercase letter");
      });
    });
    ...
    describe("invalid passwords - missing uppercase", () => {
      ...
      it("should return error for all lowercase and numbers", () => {
        expect(validatePassword("pass1234!")).toBe("Password must contain an uppercase letter");
      });
    });
  ...
  describe("validatePasswordMatch", () => {
    describe("valid password matches", () => {
      ...
      it("should return null when both passwords are identical complex strings", () => {
        expect(validatePasswordMatch("P@ssw0rd!@#$%123", "P@ssw0rd!@#$%123")).toBeNull();
      });
  ...
  describe("validateZip", () => {
    ...
    describe("invalid ZIP codes", () => {
      it("should return error for 4-digit ZIP", () => {
        expect(validateZip("1234")).toBe("Invalid ZIP code format (e.g., 12345 or 12345-6789)");
      });

      it("should return error for 6-digit ZIP", () => {
        expect(validateZip("123456")).toBe("Invalid ZIP code format (e.g., 12345 or 12345-6789)");
      });
      ...
      it("should return error for letters in ZIP", () => {
        expect(validateZip("1234A")).toBe("Invalid ZIP code format (e.g., 12345 or 12345-6789)");
      });

      it("should return error for special characters", () => {
        expect(validateZip("12345!")).toBe("Invalid ZIP code format (e.g., 12345 or 12345-6789)");
      });

      it("should return error for space in middle", () => {
        expect(validateZip("123 45")).toBe("Invalid ZIP code format (e.g., 12345 or 12345-6789)");
      });
  ...
  describe("validateName", () => {
    ...
    describe("invalid names", () => {
      ...
      it("should return error for name over 100 characters", () => {
        ...
        expect(validateName(longName)).toBe("Name must be no more than 100 characters");
      });
  ...
  describe("validateInterests", () => {
    ...
    describe("invalid interests", () => {
      ...
      it("should return error for interest with over 30 characters", () => {
        ...
        expect(validateInterests(interests)).toBe(
          "Each interest must be no more than 30 characters"
        );
      });
